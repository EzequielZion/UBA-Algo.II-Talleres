...
TEST(string_map_test, copiar_zion) {
    string_map<int> lol;
    lol.insert(make_pair("!", 100));
    string_map<int> lolCopia(lol);
}
...
/* Hice este test extra porque quería ver unas cosas
TEST(string_map_test, erase_avanzado_zion) {
    string_map<int> aux;

    aux.insert(make_pair("casa", 1));
    aux.insert(make_pair("casona", 2));
    aux.insert(make_pair("casucha", 3));
    aux.insert(make_pair("pez", 4));
    aux.insert(make_pair("pepe", 5));
    aux.insert(make_pair("cama", 6));
    aux.insert(make_pair("casar", 7));
    aux.insert(make_pair("a", 8));
    aux.insert(make_pair("ba", 9));

    aux.erase("casa");
    EXPECT_FALSE(aux.count("casa") == 1);
    EXPECT_TRUE(aux.count("casona") == 1);
    EXPECT_TRUE(aux.count("casucha") == 1);
    EXPECT_TRUE(aux.count("casar") == 1);
    EXPECT_TRUE(aux.count("cama") == 1);
    EXPECT_TRUE(aux.count("ba") == 1);

    aux.erase("cama");
    EXPECT_FALSE(aux.count("casa") == 1);
    EXPECT_FALSE(aux.count("cama") == 1);
    EXPECT_TRUE(aux.count("casona") == 1);
    EXPECT_TRUE(aux.count("casucha") == 1);
    EXPECT_TRUE(aux.count("casar") == 1);
    EXPECT_TRUE(aux.count("ba") == 1);
    ...
    EXPECT_FALSE(aux.count("casa") == 1);
    EXPECT_FALSE(aux.count("cama") == 1);
    EXPECT_FALSE(aux.count("ba") == 1);
    EXPECT_TRUE(aux.count("casona") == 1);
    EXPECT_TRUE(aux.count("casucha") == 1);
    EXPECT_TRUE(aux.count("casar") == 1);

    aux.erase("pepe");
    EXPECT_TRUE(aux.count("pez") == 1);
    EXPECT_FALSE(aux.count("pepe") == 1);

    aux.erase("pez");
    EXPECT_FALSE(aux.count("pez") == 1);
    EXPECT_FALSE(aux.count("pepe") == 1);

    aux.erase("casucha");
    EXPECT_FALSE(aux.count("casucha") == 1);

    aux.erase("casona");
    EXPECT_FALSE(aux.count("casona") == 1);

    aux.erase("casar");
    EXPECT_FALSE(aux.count("casar") == 1);
